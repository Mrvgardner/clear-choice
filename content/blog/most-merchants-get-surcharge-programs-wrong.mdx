...
Clear Choice helps merchants implement these programs correctly through [merchant services](/services/merchant-services): state and network compliance confirmed upfront, registration where required, and terminal configuration that applies fees accurately to the right payment types. A program designed to reduce your processing cost should not create a new compliance exposure. Set up correctly, it does not have to.
