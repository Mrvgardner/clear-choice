...
**A free placement agreement.** Revenue-sharing models mean zero upfront equipment cost for the dispensary. The provider supplies and maintains the machine. You supply the location and the traffic. Revenue is split based on transaction volume.
