...
const SERVICES: Record<string, Svc> = {
  'affiliate-program': {
    ...
    hero: 'Build with ISO-style freedom without the ISO-level network-fee burden.',
    icon: <Icon as={Users} />,
    bullets: ['Network-fee relief', 'Business freedom', 'Partner support'],
    plan: ['Sign up & onboarding', 'Lower-overhead partner setup', 'Grow with partner support'],
    outcomes: ['Predictable rev share', 'Freedom to manage your book', 'Long-term account support'],
  quote: { text: 'We got the freedom to run the business without paying and operating like a full ISO.', name: 'Alex', company: 'Coastal Payments' },
  ...
  watchdog: {
    title: 'Watchdog',
    slug: 'watchdog',
    hero: 'Always-on ATM protection with safer connections and real-time threat monitoring.',
    icon: <Icon as={Shield} />,
    bullets: ['24/7 monitoring', 'Safer connections', 'Threat protection'],
    plan: ['Secure connections', 'Monitor threats & failures', 'Expert support response'],
    outcomes: ['Minimized downtime', 'Faster fixes', 'Lower fraud and tampering risk'],
    productKey: 'Watchdog',
